...
\end{enumerate}
\textbf{Selected: Unity 2023 LTS} — Justification: Faster prototyping, proven VR deployment pipeline for Quest 3, better suited for educational software with frequent updates. Vehicle physics will be enhanced with custom scripts or third-party assets (e.g., Edy's Vehicle Physics).
